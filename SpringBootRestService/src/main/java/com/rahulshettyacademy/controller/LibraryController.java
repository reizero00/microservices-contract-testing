...
//	SpecificProduct specificProduct;
	...
	public Library getBookById(@PathVariable String id)
	{
		try {
	...
	public List<Library> getBookByAuthorName(@RequestParam String authorname)
	{
		return repository.findAllByAuthor(authorname);
	}
	
	@PutMapping("/updateBook/{id}")
	public ResponseEntity<Library> updateBook(@PathVariable String id,@RequestBody Library library)
	{
	...
	public SpecificProduct getProductFullDetails(@PathVariable String name) throws JsonMappingException, JsonProcessingException
	{
